                        ...
                        switch (data) {
                            ...
                            case'recent':
                                getData('/books/recent/filter', {
                                    ...
                                    to: $('[data-refreshto]').data('refreshto'),
                                    offset: function () {
                                        var oldOffset = parseInt($this.data('refreshoffset'));
                                        if (oldOffset < 1) {
                            ...
                            case'popular':
                                ...
                                break;
                            case'genres':
                                getData('/genres/slug/' + $this.data('refreshquery'), {
                                    offset: function () {
            ...
            return {
                init: function () {
                    ...
                    $('[data-likeid]').on('click', function (e) {
                        ...
                        Login().postData('/books/rateBookReview/' + $this.data('bookid'), data, function (result) {
                                ...
                                postData('/login', $this.data('send'), function (result) {
                                    if (result!=null && result.result) {
                                        ...
                                        if (result) {
                                            ...
                                            $thisStep.find('.form-input:not(.form-input_hide)[type="text"]').addClass('form-input_error').after('<div class="form-error">' + 'Неверый логин или пароль' + '</div>');
                                        }
                                    }
                                })
                            }
                        ...
                        if ($this.data('sendstatus') === 'ARCHIVED' && $this.data('check')) {
                         ...
                         Login().postData('/books/changeBookStatus/' + $this.data('bookid'), {
                                ...
                                if (result.result) {
                                    ...
                                    if ($cart.length) {
                                        var price = 0, priceOld = 0, booksId = [], booksId2 = [];
